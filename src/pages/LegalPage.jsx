    ...
    return (
        <div style={{ background: 'var(--color-bg)', color: 'white', minHeight: '100vh', padding: '40px' }}>
            <div className="page-container" style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                >
                    <ArrowLeft size={20} /> Back to Zupp
                </button>
                ...
                <div style={{ lineHeight: '1.8', fontSize: '1.1rem', color: '#ccc' }}>
                    <p style={{ marginBottom: '20px' }}>
                        Welcome to Zupp. This document outlines {isPrivacy ? 'how we handle your personal data' : 'the rules and regulations for using our Scan & Pay services'}.
                    </p>
                    ...
                    <p style={{ marginBottom: '20px' }}>
                        {isPrivacy
                            ...
                            : 'By accessing or using the Zupp platform, you agree to be bound by these Terms. If you disagree with any part of the terms, you may not access the service.'}
                    </p>
                    ...
                    <p style={{ marginBottom: '20px' }}>
                        {isPrivacy
                            ...
                            : 'Zupp Technologies shall not be liable for any indirect, incidental, special, consequential or punitive damages resulting from your use of the service.'}
                    </p>

                    <div style={{ marginTop: '80px', paddingTop: '40px', borderTop: '1px solid #333', color: '#666' }}>
                        For any legal inquiries, please contact legal@zupp.tech
                    </div>
                </div>
